...
"%":"Blob|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList|SVGAnimatedString"},
kn:{
"":"bool/Gv;",
...
Gh:{
"":"qE;a5:download},mH:href},N:target=",
...
return}throw "Unable to print message: " + String(a)}}],["","file:///Users/joaobiriba/Documents/Projects/dart/dartflightschoolbadge/web/dartflightschoolbadge.dart",,V,{
"":"",
Iq:[function(){var z,y,x,w
z=document.querySelector("#inputName")
z.toString
y=H.VM(new W.Cq(z,C.io.Ph,!1),[null])
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(V.qC()),y.Sg),[H.Kp(y,0)]).Zz()
y=document.querySelector("#generateButton")
$.Tn=y
y.toString
y=H.VM(new W.Cq(y,C.T1.Ph,!1),[null])
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(V.OL()),y.Sg),[H.Kp(y,0)]).Zz()
$.Ot=document.querySelector("#tspan3547")
$.ir=document.querySelector("#tspan3641")
y=W.Kn("ranks.json",null,null).ml(V.wA()).ml(new V.em(z))
x=$.X3
w=P.VH(new V.Lb(),x)
x.toString
...
x.textContent="Tell me your name!"}else{J.lo(x,!0)
x.textContent="Write your name!"}},"call$1","qC",2,0,8],
KL:[function(a){V.Qx(V.iO(null,null))},"call$1","OL",2,0,8],
Qx:function(a){var z,y
if(a==null)return
z=$.Ot
z.textContent=J.FN(a.xa)===!0?"":H.d(a.xa)
z=$.ir
z.textContent=J.FN(a.xa)===!0?"":H.d(a.k7)
window.localStorage.setItem("militaryUnit","{ \"f\": \""+H.d(a.xa)+"\", \"a\": \""+H.d(a.k7)+"\" } ")
z=(self.URL||self.webkitURL).createObjectURL(W.DA([J.xR(document.querySelector("#container"))],null,null))
y=document.createElement("a",null)
J.FQ(y,z)
y.textContent="Download Badge"
J.qh(y,"flightschoolBadge.svg")
J.ZP(document.querySelector("a"),y)},
dK:function(){var z,y
z=window.localStorage.getItem("militaryUnit")
if(z!=null){y=new V.W1(null,null)
y.Dn(z)
...
$.Ot.textContent="Aiaaa"
$.ir.textContent="Aiaaa"}},
W1:{
"":"a;xa,k7",
bu:function(a){return J.FN(this.xa)===!0?"":H.d(this.xa)},
Ln:function(a,b){var z
if(a==null){z=$.LC()
this.xa=J.UQ(z,$.r0().j1(J.q8(z)))}else this.xa=a
z=$.QO()
this.k7=J.UQ(z,$.r0().j1(J.q8(z)))},
Dn:function(a){var z,y
z=C.Ct.kV(a)
y=J.U6(z)
this.xa=y.t(z,"f")
this.k7=y.t(z,"a")},
static:{"":"Ij,xa,h4",iO:function(a,b){var z=new V.W1(null,null)
z.Ln(a,b)
return z},er:[function(a){var z,y
z=C.Ct.kV(a)
y=J.U6(z)
$.xa=y.t(z,"names")
$.h4=y.t(z,"ranks")},"call$1","wA",2,0,9]}}},1],["html_common","dart:html_common",,P,{
"":"",
D7:{
"":"ar;nd,h2",
...
I.$lazy($,"indexGen","Ij","r0",function(){return C.pr})
I.$lazy($,"names","xa","LC",function(){return[]})
I.$lazy($,"ranks","h4","QO",function(){return[]})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"WW",void:true,args:[W.ea]},{func:"zx",args:[J.O]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uu",void:true,args:[P.a],opt:[P.mE]},{func:"BG",args:[null],opt:[null]},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
Lb.prototype=$desc
function W1(xa,k7){this.xa=xa
this.k7=k7}W1.builtin$cls="W1"
...
if($desc instanceof Array)$desc=$desc[1]
GS.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,Az,QP,IF,n6,Ny,OM,QQ,fW,y4,d7,Um,DG,HA,vH,xO,Em,NW,rV,Wy,QF,hs,Wq,cm,Nh,cv,Fs,hY,ea,D0,as,dU,Aa,u5,Yu,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,zU,wa,tb,pA,Mi,HL,In,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,As,ii,fq,Er,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,YS,y6,RH,ho,Z2,w6,BR,vw,aG,J6,Oi,UM,WS,rq,nK,yp,c1,Mq,Nf,Nc,Mx,Zv,nA,yK,Dh,ZJ,mU,eZ,IT,nV,Zc,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,Tx,HC,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,ZG,ox,ZD,vt,wD,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,HY,F0,FK,Gv,kn,CD,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,AP,yH,FA,Av,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Pe,Eq,lb,tD,hJ,cu,dC,wN,VX,a7,i1,xy,MH,U5,SO,SU,Ca,b8,Pf,Lj,vs,da,xw,dm,rH,ZL,mi,jb,wB,Pu,cb,lz,Rl,Jb,M4,B5,PI,j4,i9,MO,Kd,UO,Bc,VT,Fj,q1,Zz,ly,MF,u8,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,v1,uR,QX,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,JC,f1,Uk,wI,by,QM,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,aE,kM,EH,An,c8,a,mE,Rn,wv,VG,dx,ec,Kx,hH,bU,e7,hm,kE,cX,DE,Fk,RO,Cq,xC,Pb,W9,dW,mg,ue,iY,C0,Rd,em,Lb,W1,D7,Zf,GS]}